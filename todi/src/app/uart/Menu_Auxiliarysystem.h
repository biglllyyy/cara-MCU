...
typedef struct {
    U8 oilpump_dcac_w_output_current[4];		//油泵DC/AC W相输出电流, 0 A
    U8 oilpump_dcac_v_output_current[4];		//油泵DC/AC V相输出电流, 0 A
    U8 oilpump_dcac_u_output_current[4];		//油泵DC/AC U相输出电流, 0 A
    int8_t radiator_temp;						//散热器温度, 0 ℃
