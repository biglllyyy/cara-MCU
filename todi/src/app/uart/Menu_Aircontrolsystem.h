...
typedef struct {
    ...
    U8 ac_out_temp;			//车外实际温度, 0 ℃0.5℃/bit，-30
    U8 ac_in_temp;			//车内实际温度, 0 ℃0.5℃/bit，-30
    U8 ac_set_temp;			//设定温度, 0 ℃ 0.5℃/bit，-30
...
void get_AC_system(void)
{
	...
	s_AC_para.ac_out_temp = Outdoor_t;
	s_AC_para.ac_in_temp = Indoor_t;
	s_AC_para.ac_set_temp = Set_t;
