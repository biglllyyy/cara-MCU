...
//	pin_filter_in[PIN_IN_01].valid_value = 1;
//	pin_filter_in[PIN_IN_02].valid_value = 1;
//	pin_filter_in[PIN_IN_03].valid_value = 1;
//	pin_filter_in[PIN_IN_04].valid_value = 1;
//	pin_filter_in[PIN_IN_05].valid_value = 1;
//	pin_filter_in[PIN_IN_06].valid_value = 1;
//	pin_filter_in[PIN_IN_07].valid_value = 1;
//	pin_filter_in[PIN_IN_08].valid_value = 1;
//	
//	pin_filter_in[PIN_IN_15].valid_value = 1;
//	pin_filter_in[PIN_IN_16].valid_value = 1;
//	pin_filter_in[PIN_IN_17].valid_value = 1;
//	pin_filter_in[PIN_IN_18].valid_value = 1;
//	pin_filter_in[PIN_IN_19].valid_value = 1;
//	pin_filter_in[PIN_IN_20].valid_value = 1;
//	pin_filter_in[PIN_IN_21].valid_value = 1;
//	pin_filter_in[PIN_IN_22].valid_value = 1;
